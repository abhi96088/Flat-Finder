...
class _SavedScreenState extends State<SavedScreen> {
  ...
  Future<void> fetchBookmarkedProperties() async {
    try {
      ...
      print('Fetched Bookmarked Properties: ${snapshot.docs.map((e) => e.data())}');
    } catch (e) {
    ...
    return Scaffold(
      ...
      body: bookmarkedListings.isEmpty
        ...
        itemBuilder: (context, index) {
          var listing = bookmarkedListings[index].data() as Map<String, dynamic>;
          ...
          return CardSmall(
            ...
            imageUrl: listing['imageUrls'] != null && listing['imageUrls'].isNotEmpty
                ? listing['imageUrls'][0] : 'https://via.placeholder.com/150', // Placeholder image
          );
        },
      ),
    );
