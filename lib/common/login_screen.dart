...
import 'package:flat_finder/widgets/login_signup_small_button.dart';
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      const Spacer(),
                      Text("Don't have an account ?", style: TextStyle(fontSize: 16, color: Colors.white.withOpacity(0.9), fontFamily: 'Inter'),),
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.center,
                          children: [
                            ...
                            const Text("Welcome back", style: TextStyle(fontSize: 30, fontFamily: "Poppins-Semibold"),),
                            ...
                            FullWidthButton(
                                text: "Login",
                                onPressed: (){
                                  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => const BottomNavigationTenant()));
                                }
                            ),
                            const SizedBox(height: 40,),
